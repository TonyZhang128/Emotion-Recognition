...
SAVE_ROOT  = r"D:\song_LD\stu_models_arousal"         # 每个模态会建子文件夹
...
if __name__ == "__main__":
    ...
    # # 1) ECG（2 通道）
    # train_student_modal(
    #     modal_name="ECG_arousal",
    #     data_mat_name="stu_test_arousal_ECGdata.mat",
    #     label_mat_name="stu_test_arousal_ECGlabel.mat",
    #     C_expected=2,
    #     **common_kwargs
    # )
    #
    # # 2) EEG（24 通道）
    # train_student_modal(
    #     modal_name="EEG_arousal",
    #     data_mat_name="stu_test_arousal_EEGdata.mat",
    #     label_mat_name="stu_test_arousal_EEGlabel.mat",
    #     C_expected=24,
    #     **common_kwargs
    # )
    ...
    # 3) GSR（1 通道）
    train_student_modal(
        modal_name="GSR_arousal",
        data_mat_name="stu_test_arousal_GSRdata.mat",
        label_mat_name="stu_test_arousal_GSRlabel.mat",
        C_expected=1,
        **common_kwargs
    )
